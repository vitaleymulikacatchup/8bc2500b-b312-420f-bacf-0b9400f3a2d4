...
export const metadata: Metadata = {
  ...
  description: "Experience world-class hospitality at Grand Vista Hotel. Luxury rooms, premium amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, spa, fine dining, business travel",
  ...
  openGraph: {
    title: "Grand Vista Hotel - Luxury 5-Star Accommodations",
    description: "Experience world-class hospitality at Grand Vista Hotel with luxury rooms, premium amenities, and exceptional service.",
